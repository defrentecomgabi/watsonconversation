...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String ATOR_USUARIO = "1";
    public static final String ATOR_WATSON = "2";
    public String conversation_message = "";
    ...
    private void sendMessage() {
        ...
        Log.e("LOG", "Send_message: " + this.conversation_message);

        //final String inputmessage = this.conversation_message;
    ...
    private class MicrophoneRecognizeDelegate implements RecognizeCallback {
        ...
        public void onTranscription(SpeechResults speechResults) {
            ...
            if(speechResults.getResults() != null && !speechResults.getResults().isEmpty()) {
                ...
                //showMicText(text);
                Message outMessage=new Message();
                outMessage.setId(ATOR_USUARIO);
                outMessage.setMessage(text);
                messageArrayList.add(outMessage);
                conversation_message = text;

                Log.e("LOG", "Conversation_message: " + text);
                ...
                Thread thread = new Thread(new Runnable(){
                    public void run() {
                        try {
                            ...
                            ConversationService service = new ConversationService(ConversationService.VERSION_DATE_2017_02_03);
                            service.setUsernameAndPassword(conversation_username, conversation_password);
                            MessageRequest newMessage = new MessageRequest.Builder().inputText(conversation_message).context(context).build();
                            MessageResponse response = service.message(workspace_id, newMessage).execute();
                            String text = response.getText().get(0);
                            Log.e("LOG", text);
                            Message outMessage=new Message();
                            outMessage.setId(ATOR_WATSON);
                            outMessage.setMessage(text);
                           ...
                           e.printStackTrace();
                           Log.e("ERROR", "Exceção no envio de dados pro Watson", e);
                        }

                            Log.e("LOG", "Entrei na thread!!");
                    }
                });
